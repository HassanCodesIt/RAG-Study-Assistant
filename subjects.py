...
# def get_pdf_by_subject(subject):
#     chroma_client = chromadb.PersistentClient(path="./vecDB1")
#     collection = chroma_client.get_or_create_collection(name=subject)
#     a=collection.get()["metadatas"] 
#     return a

# def get_id_by_filename(subject,filename):
#     chroma_client = chromadb.PersistentClient(path="./vecDB1")
#     collection = chroma_client.get_or_create_collection(name=subject)
...
# pdf_text = extraction(file_path="sample.pdf")

# new_id = vectordbadd(pdf_text, "chemistry")


# context = vectordbget("chemistry", new_id)
